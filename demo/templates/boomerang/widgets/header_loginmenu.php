        ...
        <div class="container">
            <div class="row">
               <!---<div class="col-sm-12 login-menu">
                    <span class="aux-text" style="float:right">
                        {not_logged}
				<a  class="btn btn-success" href="{front_login_url}#content"><i class="icon-user"></i> Submit a free Ad</a>
						   ...
						   <a href="{front_login_url}#content"><i class="icon-user"></i> My Account</a>
				...
				<p class="language">
					...
					<a href="signup.html" class="link"><i class="fa fa-key"></i>
