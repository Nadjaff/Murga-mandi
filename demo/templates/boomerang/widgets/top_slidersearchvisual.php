            ...
            <div class="container-fluid no-padding">
                <div class="row-fluid">
                    <div class="">
                        <!-- JumboTron -->
                        <div class="jumbotron">
                                <div id="homepageCarousel" class="carousel carousel-1 carousel-fixed-height slide jumbotron-left" data-ride="carousel">
                            ...
                            <div class="jumbotron-right">
                                ...
                                <div class="panel panel-base no-margin">
                                    ...
                                    <?php if(config_db_item('property_subm_disabled')==FALSE):  ?>
                                        <a class="pull-right mylisting btn-base" href="{myproperties_url}"><i class=" icon-folder-close-alt"></i><?php _l('Submit Property');?></a>
                                    <?php endif;?>
                                    </div>
