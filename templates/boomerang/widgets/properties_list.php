    ...
    <div class="col-md-12">
        <div class="wp-block property list">
            <div class="wp-block-title">
                <h3>{lang_Info} : <a href="<?php echo $item['url']; ?>" hidefocus="true"><?php echo _ch($item['address']); ?></a></h3>
            </div>
            ...
            <ul class="aux-info row-fluid">
                <?php
                    ...
                    if($elem->type == 'DROPDOWN' || $elem->type == 'INPUTBOX'):
                     ?>
                <li><i class="fa <?php _che($elem->f_class); ?>"></i><small><span style="<?php _che($elem->f_style); ?>"><?php echo _ch(${"options_name_$elem->f_id"}, '-'); ?></span><?php echo _ch($item['option_'.$elem->f_id], '-'); ?> <?php echo _ch(${"options_suffix_$elem->f_id"}, ''); ?> </small></li>
                     <?php 
