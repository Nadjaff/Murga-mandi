                                ...
                                <div class="pannel-hrading"><h4 class="headingcropm" style="padding-left: 14px;">{lang_ChatWithSeller}</h4></div>
                                <form method="post" class="property-form" action="{page_current_url}#form">
                                    ...
                                    <div class="form-group form-group {form_error_captcha}">
                                        <div class="row">
                                            <div class="col-lg-5" style="padding-top:1px;">
                                                <?php echo $captcha[ 'image']; ?>
                                            </div>
                                            <div class="col-lg-7">
                                                <input class="captcha form-control {form_error_captcha}" name="captcha" type="text" placeholder="{lang_Captcha}" style="font-size: 13px;" value="" />
                                   ...
                                   <?php endif; ?>
                                    ...
                                    <button  class="btn btn-lg btn-block-bm btn_org btn-alt btn-icon btn-icon-right" type="submit">
                                        <span>{lang_Submit}</span>
                                    </button>
                                </form>
                            </div>