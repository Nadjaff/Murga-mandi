...
<div class="section-title-wr">
    <h3 class="section-title left" style="font-size: 16px;color: #0066e6;font-weight: 400;"><span><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;&nbsp;{lang_Contactform}</span></h3>
</div>
<p></p>
<?php if(count($has_settings_email) > 0): ?>
<form  method="post" class="form-light mt-20 property-form" role="form" action="{page_current_url}#form">
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <?php //if(config_item('captcha_disabled') === FALSE): ?>
                <!---<div class="row">
                    <div class="col-md-3 col-sm-2 col-xs-2" style="padding-top:22px;">
    ...
    <div class="row">
        ...
        <div class="col-md-6">		    <button type="submit" class="btn btn_org">			<span>{lang_Submit}</span>			</button>
