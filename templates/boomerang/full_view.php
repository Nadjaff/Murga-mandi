                            ...
                            <div class="layout">
                                ...
                                <script type="text/javascript" charset="utf-8">
								 ...
								 url:'<?php echo base_url("index.php/searchlisting/search").'?cityfield='.$_GET['cityfield'].'&ads_search='.$_GET['cityfield'] ?>&min='+min+'&max='+max+'&wt_min='+wt_min+'&wt_max='+wt_max,
									...
									$(document).ready(function(){
									 $('#ser_filt').change(function() {
									 var varia = $(this).val();
									 var url="<?php echo base_url('index.php/searchlisting/search').'/'.$lang_code.'?user='.$_GET['user'].'&is_featured='.$_GET['is_featured'].'&cityfield='.$_GET['cityfield'].'&ads_search='.$_GET['ads_search'].'&min='.$_GET['min'].'&max='.$_GET['max'].'&wt_min='.$_GET['wt_min'].'&wt_max='.$_GET['wt_max'].'&dst_min='.$_GET['dst_min'].'&dst_max='.$_GET['dst_max']?>&sort_by="+varia;
										location.href=url;
										});
									});
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4 col-sm-6">
            <div class="viewas">
                <p>Short by
                    <select class="form-control-filter" id="ser_filt">
                        <option value="recent" <?php if(isset($_GET['sort_by']) && ($_GET['sort_by']=='recent')){echo 'selected';} ?>>Most Recent</option>
                        <option value="low"  <?php if(isset($_GET['sort_by']) && ($_GET['sort_by']=='low')){echo 'selected';} ?>>Price: Rs Low to High</option>
                        <option value="high"   <?php if(isset($_GET['sort_by']) && ($_GET['sort_by']=='high')){echo 'selected';} ?>>Price: Rs High to Low</option>
                    </select>
                </p>
            </div>
        </div>
                ...
                <div class="row">				
                    <div class="col-md-12 col-sm-12">
						...
						<?php if($rec_val['is_featured'] == 1){echo "<span class='discount_lable'>FEATURED</span>"; }else{
                            ...
                            <a href="<?php 
							echo site_url('/property/'.$rec_val['id'].'/'.$lang_code); ?>"><img height="300" src="<?php echo base_url('files').'/'.$rec_val['image_filename'];?>"></a>
							<?php 
							/* 
                    ...
                    <div class="col-md-12 col-sm-12">
                        <a href="<?php 
							echo site_url('/property/'.$rec_val['id'].'/'.$lang_code); ?>">
                            <div class="head-crop">
