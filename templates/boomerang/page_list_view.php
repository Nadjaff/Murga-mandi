                                ...
                                <script type="text/javascript" charset="utf-8">
								    $(document).ready(function (){
									  $(".jslider-pointer").click(function(){
										...
										var min=str_val[0];
										var max=str_val[1];
										var url="<?php echo base_url('index.php/searchlisting/search').'/'.$lang_code.'?user_id='.$_GET['user_id'].'&is_featured='.$_GET['is_featured'].'&cityfield='.$_GET['cityfield'].'&ads_search='.$_GET['cityfield'] ?>&min="+min+"&max="+max+"&wt_min="+wt_min+"&wt_max="+wt_max+"&dst_min="+dst_min+"&dst_max="+dst_max+"&sort_by=";
										//alert(url);
										location.href=url;
									...
									$(document).ready(function(){
									 ...
									 var varia = $(this).val();
									 var url="<?php echo base_url('index.php/searchlisting/search').'/'.$lang_code.'?user_id='.$_GET['user_id'].'&is_featured='.$_GET['is_featured'].'&cityfield='.$_GET['cityfield'].'&ads_search='.$_GET['ads_search'].'&min='.$_GET['min'].'&max='.$_GET['max'].'&wt_min='.$_GET['wt_min'].'&wt_max='.$_GET['wt_max'].'&dst_min='.$_GET['dst_min'].'&dst_max='.$_GET['dst_max']?>&sort_by="+varia;
										location.href=url;
										});
									});
                ...
                <div class="row">				
                    <div class="col-md-3 col-sm-4">
						...
						<?php if($rec_val['is_featured'] == 1){echo "<span class='discount_lable'>FEATURED</span>"; }else{
                            ...
                            <a href="<?php 
							echo site_url('/property/'.$rec_val['id'].'/'.$lang_code); ?>"><img height="160" src="<?php echo base_url('files').'/'.$rec_val['image_filename'];?>"></a>
							<?php 
							/* 
                    ...
                    <div class="col-md-9 col-sm-9">
						...
						<div class="row">
							<a href="<?php 
							echo site_url('/property/'.$rec_val['id'].'/'.$lang_code); ?>"></a>
