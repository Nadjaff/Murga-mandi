...
<h2 style="margin: 19px 0 5px;
    color: #2965be;
    font-size: 17px;
    font-weight: normal;" ><?php echo lang_check('Account settings'); ?></h2>

<p><?php echo lang_check('Here you can change your account settings'); ?></p>
<ul class="nav nav-tabs">        
<li ><a href="<?php echo site_url('frontend/myproperties/'.$this->data['lang_code']) ?>"><?php echo lang_check('Ads') ?></a></li>    
...
<li class="active"><a data-toggle="tab" href="#menu3"><?php echo lang_check('Settings') ?></a></li>  </ul>  
<div class="tab-content">    
<div id="" class="tab-pane fade in active">             <div class="property_content panel-body">                    
<h2 class="change"><?php echo lang_check('Change Personal Details'); ?></h2>
                    ...
                    <?php echo form_open(NULL, array('class' => 'form-horizontal form-estate', 'role'=>'form'))?>                              
                                ...
                                <div class="col-md-6">
                                  <label class=""><?php echo lang('FirstLast')?></label>                                   <br>
                                  <div class="controls">
                                ...
                                </div>								<div class="col-md-6">                                  <label class=""><?php echo lang('Email')?></label>                                  <div class="controls">                                    <?php echo form_input('mail', set_value('mail', $user_data['mail']), 'class="form-control" id="inputEmail" placeholder="'.lang('Email').'"')?>                                  </div>                                </div>                                								 <div class="col-md-6">                                  <label class=""><?php echo lang('Phone')?></label>                                  <div class="controls">                                    <?php echo form_input('phone', set_value('phone', $user_data['phone']), 'class="form-control" id="inputPhone" placeholder="'.lang('Phone').'"')?>                                  </div>                                </div>								  								  								   <div class="col-md-6">                                  <label class=""><?php echo lang('Address')?></label>                                  <div class="controls">                                    <?php echo form_input('address', set_value('address', $user_data['address']), 'placeholder="'.lang('Address').'" rows="3" class="form-control"')?>                                  </div>                                </div>															  								
<div class="inp">                                  <!-- [Custom fields] -->                       
<?php
...
<!-- [/Custom fields] -->
                                <div class="col-md-12 cal-pad">
				                  ...
				                  <label for="InputFile"><?php echo lang_check('Upload Profile Picture'); ?></label><br>
                                ...
                                <div class="col-md-12">
									...
									<label><input type="checkbox"><?php echo lang_check('Share Phone Number'); ?> </label>

								</div>
                                 <button type="submit" class="btn btn_org" style="    margin-left: 17px;">Save Details</button>
                                ...
                                <div class="col-md-4">
                                  <label class=""><?php echo lang('PasswordConfirm')?></label>
                                  <div class="controls">
                               ...
                               <!-- <div class="control-group">
                                ...
                                <div class="control-group">
                                  <div class="controls">
                                    <?php echo form_submit('submit', lang('Save'), 'class="btn btn_org btn_styp"')?>
                                  </div>
                                </div>
	...
	<h3 style="margin-left: 17px;">Email Notification</h3>
   <div class="che">
	<?php
    custom_fields_print_f('custom_fields_code');
    ?> 
	...
	<p>You will lose all your Ads, Favorites, Messages and Credits after deleting your Account.</p>
