...
<html>  
    <head>
        <?php _widget('head'); ?>      
		<style>		   select#inputOption_1_38,#inputOption_1_6,#inputOption_1_4,#inputOption_1_54,#inputOption_1_2,#inputOption_1_2,#inputOption_1_3,#inputOption_1_95 {			   width:100% !important;            }			select#inputOption_1_79_level_0,#inputOption_1_64_level_0 {            margin-left: -8%;          }   select#inputOption_1_79_level_1,#inputOption_1_64_level_1 {    margin-left: -5%;}	
			.col-md-6 {
    margin-left: 0px !important;
}
		.TREE-GENERATOR select:nth-child(2) {
			width:48.4% !important;
		}
		.TREE-GENERATOR select:nth-child(3) {
			width: 48.4% !important;
		...
		<script src="assets/cache/big_js.js"></script>
                            ...
                            <div class="col-md-12">
                                <div id="main-inner">
                                    <div id="content" class="container">
                                        <!-- SLOGAN -->
                                         <div class="block-content block-content-small-padding" style="    margin-top: 27px;    margin-left: -14px;    width: 100%;">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="row-fluid">
                                                        <div class="span12 panel panel-default panel-sidebar-1 affix-parent">
                                                            <div class="panel-heading"><h1 class="headingcropm"2>{lang_Propertydata}</h1></div>
...
<?php echo form_open(NULL, array('class' => 'form-horizontal form-estate', 'role' => 'form')) ?>                              
			<div class="row" style="margin-left: 0px;">
				<div class="col-md-6 form-group edit_inp">
                    <label class="col-md-12"><?php echo lang('Address') ?></label> 
					<?php echo form_input('address', set_value('address', $estate['address']), 'class="form-control col-md-12" id="inputAddress" onblur="codeAddress()" placeholder="' . lang('Address') . '"') ?>
                </div>

                <div class="col-md-6 form-group edit_inp">
					<label class="col-md-12">
					<?php echo lang('Gps') ?></label>
                    <?php echo form_input('gps', set_value('gps', $estate['gps']), 'class="form-control col-md-12" id="inputGps" placeholder="' . lang('Gps') . '"  readonly') ?>
                    
                </div>
			</div>
                <h5><?php echo lang('Translation data') ?></h5>
                <div role="tabpanel" style="margin-bottom: 0px;" class="tabbable">
                    <!--<ul class="nav" data-spy="affix" data-offset-top="650" role="tablist">
<?php $i = 0;
...
<?php $i = 0;
foreach ($this->option_m->languages as $key => $val){ $i++; ?>
                                                                            <div id="<?php echo $key ?>" role="tabpanel" class="tb_edt tab-pane <?php echo $i == 1 ? 'active' : '' ?>">
   ...
   <?php
                                                                                ...
                                                                                ?>
                                                                                    ...
                                                                                    <?php if ($val_option['type'] == 'CATEGORY'): ?>
                                                                                        ...
                                                                                        <h5 class="col-md-12"><hr /><?php echo $val_option['option'] ?> <span class="checkbox-visible"><?php echo form_checkbox('option' . $val_option['id'] . '_' . $key, 'true', set_value('option' . $val_option['id'] . '_' . $key, isset($estate['option' . $val_option['id'] . '_' . $key]) ? $estate['option' . $val_option['id'] . '_' . $key] : ''), 'id="inputOption_' . $key . '_' . $val_option['id'] . '"') ?> <?php echo lang_check('Hidden on preview page'); ?></span><hr /></h5>

                                                                                    <?php elseif ($val_option['type'] == 'INPUTBOX' || $val_option['type'] == 'DECIMAL' || $val_option['type'] == 'INTEGER'): ?>
                                                                                        <div class="col-md-6 form-group <?php echo ($val_option['is_frontend'] ? '' : ' hidden') ?>">  

			<label class="col-md-12">
			<?php echo $required_notice . $val_option['option'] ?><?php if(!empty($options_lang[$key][$key_option]->hint)):?><i class="icon-question-sign hint" data-hint="<?php echo $options_lang[$key][$key_option]->hint;?>"></i><?php endif;?></label>

                                                                                        <?php echo form_input('option' . $val_option['id'] . '_' . $key, set_value('option' . $val_option['id'] . '_' . $key, isset($estate['option' . $val_option['id'] . '_' . $key]) ? $estate['option' . $val_option['id'] . '_' . $key] : ''), 'class="form-control col-md-12' . $val_option['type'] . '" id="inputOption_' . $key . '_' . $val_option['id'] . '" placeholder="' . $val_option['option'] . '" ' . $required_text . ' ' . $max_length_text) ?>
		...
		<label class="col-md-12"><?php echo $required_notice . $val_option['option'] ?><?php if(!empty($options_lang[$key][$key_option]->hint)):?><i class="icon-question-sign hint" data-hint="<?php echo $options_lang[$key][$key_option]->hint;?>"></i><?php endif;?></label>
            ...
            echo form_dropdown('option' . $val_option['id'] . '_' . $key, $drop_options, $drop_selected, 'class="form-control col-md-12" id="inputOption_' . $key . '_' . $val_option['id'] . '" placeholder="' . $val_option['option'] . '" ' . $required_text)
            ?>
                                                                                           </div>
                                                                                    <?php elseif ($val_option['type'] == 'TEXTAREA'): ?>
                                                                                        <div class="col-md-6 form-group<?php echo ($val_option['is_frontend'] ? '' : ' hidden') ?>">
                                                                                            <label class="col-md-12"><?php echo $required_notice . $val_option['option'] ?><?php if(!empty($options_lang[$key][$key_option]->hint)):?><i class="icon-question-sign hint" data-hint="<?php echo $options_lang[$key][$key_option]->hint;?>"></i><?php endif;?></label>
                                                                                                ...
                                                                                                <?php echo form_input('option' . $val_option['id'] . '_' . $key, set_value('option' . $val_option['id'] . '_' . $key, isset($estate['option' . $val_option['id'] . '_' . $key]) ? $estate['option' . $val_option['id'] . '_' . $key] : ''), 'class="cleditor col-md-12 form-control" id="inputOption_' . $key . '_' . $val_option['id'] . '" placeholder="' . $val_option['option'] . '" ' . $required_text) ?>
																						</div>
                                                                                            <?php elseif ($val_option['type'] == 'TREE' && config_item('tree_field_enabled') === TRUE): ?>
                                                                                        <div class="col-md-12 TREE-GENERATOR">
                                                                                            <label class="col-md-12">
                                                                                               ...
                                                                                               // echo '<div class="col-md-6 field-row">';
                                                                                                echo form_dropdown('option' . $val_option['id'] . '_' . $key . '_level_0', $drop_options, $drop_selected, 'class="form-control col-md-6" id="inputOption_' . $key . '_' . $val_option['id'] . '_level_0' . '" placeholder="' . $val_option['option'] . '"');
                                                                                               // echo '</div>';
                                                                                                ...
                                                                                                if ($levels_num > 0)
                                                                                                    for ($ti = 1; $ti <= $levels_num; $ti++) {
                                                                                                      //  echo '<div class="col-md-6 field-row">';
                                                                                                        echo form_dropdown('option' . $val_option['id'] . '_' . $key . '_level_' . $ti, array('' => lang_check('Please select parent')), array(), 'class="form-control col-md-6" id="inputOption_' . $key . '_' . $val_option['id'] . '_level_' . $ti . '" placeholder="' . $val_option['option'] . '"');
                                                                                                       // echo '</div>';
                                                                                                    }
                                                                                                ?>
             ...
             <div class="col-md-12">                                                                                  
			              <div class="field-row hidden">
                                                                                                ...
                                                                                                <?php if (empty($estate['id'])): ?>
                                                                                                    ...
                                                                                                    <br style="clear:both;" />
                                                                                                <?php else: ?>
                <div class="col-md-12">                                                                                    <!-- Button to select & upload files -->
                                                                                              <span class="btn btn-success fileinput-button" style="margin-top: 4px;">
...
<?php echo form_close() ?>
                                                    ...
                                                    <div class="row-fluid">
                                                        																																										<div class="span12">                                                            <div class="panel panel-default panel-sidebar-1 property_content box">                                                                <?php if (!isset($estate['id'])): ?>                                                                    <span class="label label-danger"><?php echo lang_check('After saving, you can add files and images'); ?></span><?php else: ?>                                                                    <div id="page-files-<?php echo $estate['id'] ?>" rel="estate_m">                                                                        <!-- The file upload form used as target for the file upload widget -->                                                                        <form class="fileupload" action="<?php echo site_url('files/upload_estate/' . $estate['id']); ?>" method="POST" enctype="multipart/form-data">                                                                            <!-- Redirect browsers with JavaScript disabled to the origin page -->                                                                            <noscript><input type="hidden" name="redirect" value="<?php echo site_url('admin/estate/edit/' . $estate['id']); ?>"></noscript>                                                                            <!-- The fileupload-buttonbar contains buttons to add/delete files and start/cancel the upload -->                                                                            <div class="fileupload-buttonbar">                                                                                <div class=" col-md-6 nopadding">                                                                                    <!-- The fileinput-button span is used to style the file input field as button -->                                                                                    <span class="btn btn-success fileinput-button">                                                                                        <i class="icon-plus icon-white"></i>                                                                                        <span><?php echo lang_check('Addfiles') ?></span>                                                                                        <input type="file" name="files[]" multiple>                                                                                    </span>                                                                                    <button type="reset" class="btn btn-warning cancel">                                                                                        <i class="icon-ban-circle icon-white"></i>                                                                                        <span><?php echo lang_check('Cancelupload') ?></span>                                                                                    </button>                                                                                    <button type="button" class="btn btn-danger delete">                                                                                        <i class="icon-trash icon-white"></i>                                                                                        <span><?php echo lang_check('Deleteselection') ?></span>                                                                                    </button>                                                                                    <input type="checkbox" class="toggle" />                                                                                </div>
																																																								<!-- The global progress information -->                                                                                <div class=" col-md-6 fileupload-progress fade">                                                                                    <!-- The global progress bar -->                                                                                    <div class="progress progress-success progress-striped active" role="progressbar" aria-valuemin="0" aria-valuemax="100">                                                                                        <div class="bar" style="width:0%;"></div>                                                                                    </div>                                                                                    <!-- The extended global progress information -->                                                                                    <div class="progress-extended">&nbsp;</div>                                                                                </div>                                                                            </div>                                                                            <!-- The loading indicator is shown during file processing -->                                                                            <div class="fileupload-loading"></div>                                                                            <br />                                                                            <!-- The table listing the files available for upload/download -->                                                                            <!--<table role="presentation" class="table table-striped">                                                                            <tbody class="files" data-toggle="modal-gallery" data-target="#modal-gallery">-->
						
																																																		<div role="presentation" class="fieldset-content">                                                                                <ul class="files files-list-u" data-toggle="modal-gallery" data-target="#modal-gallery">          <?php if (isset($files[$estate['repository_id']])) foreach ($files[$estate['repository_id']] as $file): ?>                                                                                            <li class="img-rounded template-download fade in">                                                                                                <div class="preview">                                                                                                    <img class="img-rounded" alt="<?php echo $file->filename ?>" data-src="<?php echo $file->thumbnail_url ?>" src="<?php echo $file->thumbnail_url ?>">                                                                                                </div>                                                                                                <div class="filename">                                                                                                    <code><?php echo character_hard_limiter($file->filename, 20) ?></code>                                                                                                </div>                                                                                                <div class="options-container">            <?php if ($file->zoom_enabled): ?>                                                                                                        <a data-gallery="gallery" href="<?php echo $file->download_url ?>" title="<?php echo $file->filename ?>" download="<?php echo $file->filename ?>" class="zoom-button btn btn-mini btn-success"><i class="icon-search icon-white"></i></a>                                                                                                                          <a class="btn btn-mini btn-info iedit visible-inline-block-lg" rel="<?php echo $file->filename ?>" href="#<?php echo $file->filename ?>"><i class="icon-pencil icon-white"></i></a>            <?php else: ?>                                                                                                        <a target="_blank" href="<?php echo $file->download_url ?>" title="<?php echo $file->filename ?>" download="<?php echo $file->filename ?>" class="btn btn-mini btn-success"><i class="icon-search icon-white"></i></a>            <?php endif; ?>                                                                                                    <span class="delete">                                                                                                        <button class="btn btn-mini btn-danger" data-type="POST" data-url="<?php echo $file->delete_url ?>"><i class="icon-trash icon-white"></i></button>                                                                                                        <input type="checkbox" value="1" name="delete">                                                                                                    </span>                                                                                                </div>                                                                                            </li>        <?php endforeach; ?>                                                                                </ul>                                                                                <br style="clear:both;"/>                                                                            </div>                                                                        </form>                                                                    </div><?php endif; ?>                                                            </div>                                                        </div></div>
...
$(document).ready(function(){
    ...
    /**************** custom code **************/
$('input[name="option10_1"]').blur(function(){
 var inp_val = $(this).val(); 
  $('input[name="option10_3"]').val(inp_val);
  
});
$('input[name="option3_1"]').blur(function(){
 var inp_val = $(this).val(); 
  $('input[name="option3_3"]').val(inp_val);
...
function codeAddress() {
    ...
    geocoder.geocode( { 'address': address}, function(results, status) {
      if (status == google.maps.GeocoderStatus.OK) {
        ...
        document.getElementById("inputGps").value = lat1+', '+lng2;
      } 
...
<script src="assets/js/allcity1.js"></script>
<script src="assets/js/allcity2.js"></script>
    </body>
</html>