                ...
                <div class="jumbotron">
                    ...
                    <div class="jumbotron-right panel panel-base" style='margin: 0;'>
                        ...
                        <div class="panel panel-base no-margin">
                            <div class="panel-heading panel-heading-lg clearfix"><span class='search-title' style="padding-top: 8px;"><?php _l('Find Properties');?></span>
                            <?php if(config_db_item('property_subm_disabled')==FALSE):  ?>
                                <a class="pull-right mylisting btn-base" data-toggle="tooltip" title="teste" href="{myproperties_url}"><i class=" icon-folder-close-alt"></i><?php _l('Submit Property');?></a>
                            <?php endif;?>
                            </div>
                            <form class="form-base search-form" role="form" >
                                ...
                                <div class="advanced-form-part hidden">
                                    ...
                                    <input id="search_option_<?php _che($treefield_id);?>" type="text" class="span3 search_option_<?php _che($treefield_id);?>" placeholder="{options_name_<?php _che($treefield_id);?>}" value="<?php echo search_value($treefield_id); ?>" />
