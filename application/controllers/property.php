...
class Property extends Frontend_Controller
{
    ...
    public function index()
    {
        ...
        //$this->data['pro_user'] = $this->estate_m->user_data_get($property_id);
		//print_r($this->data['pro_user']);
...
//                    }
        ...
        $search_array = array();
		$this->data['user_dt'] = $this->estate_m->user_data_get($property_id);
        $this->data['all_estates'] = array();
		$this->data['all_estates']['dd']= $this->estate_m->get_distance($property_id);
