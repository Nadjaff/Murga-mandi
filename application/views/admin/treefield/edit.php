                    ...
                    <div class="widget-content">
                        <div class="padd">
                            ...
                            <div class="form-group">
                                <!--<label class="col-lg-3 control-label"><?php //echo lang('Parent') ?></label>-->								<label class="col-lg-3 control-label"><?php echo lang('Category') ?></label>																	<?php 														unset($treefield_no_parents["0"]) ;?>								
                                <div class="col-lg-9">													<input type="text" class="form-control" value="Cattle" readonly>									<input type="hidden" name="parent_id" class="form-control" value="238" readonly>									
                                    <?php //echo form_dropdown('parent_id', $treefield_no_parents, $this->input->post('parent_id') ? $this->input->post('parent_id') : $treefield->parent_id, 'class="form-control", selected readonly') ?>									
                                </div>
                            </div>
...
foreach ($this->option_m->languages as $key => $val):$i++; ?>
                                <div id="<?php echo $key ?>" class="tab-pane <?php echo $i == 1 ? 'active' : '' ?>">
                                    <div class="form-group">
                                        <!---<label class="col-lg-3 control-label"><?php //echo lang_check('Value') ?></label>-->																				<label class="col-lg-3 control-label"><?php echo lang_check('SubCategory') ?></label>
                                        <div class="col-lg-9">
...
<?php if (count($tree_listings)): foreach ($tree_listings as $listing_item): ?>
                                <tr>
                                    ...
                                    <td><?php if($listing_item->level > 0){										echo '&nbsp;&nbsp';									}echo $listing_item->value; ?></td>
