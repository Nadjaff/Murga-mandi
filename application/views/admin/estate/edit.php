                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <?php echo form_open(NULL, array('class' => 'form-horizontal form-estate', 'role'=>'form'))?>                              
                                ...
                                <?php endif;?>
                                <div class="form-group">								<?php //print_r($doctr); ?>								
                                  <label class="col-lg-3 control-label"><?php echo lang('Agent')?></label>
                                  <div class="col-lg-9">									<select name="agent" class="form-control ui-state-valid" id="inputAgent" placeholder="Doctor">										<option value="" selected="selected">Current user / Not defined</option>										<?php foreach($doctr as $val){ ?>										<option value="<?php echo $val['id']; ?>"><?php echo $val['username']; ?> </option>										<?php } ?>									</select>								  								  
                                    <?php //echo form_dropdown($available_agent, set_value('agent', $estate->agent), 'class="form-control" id="inputAgent" placeholder="'.lang('Agent').'" hidden')?>
                                  </div>
                                </div>
                                <?php endif;?>
