    ...
    <div class="containerk">
      ...
      <!-- Menu button for smallar screens -->
		...
		<div class="navbar-header">
		  ...
		  <a href="<?php echo site_url('admin/dashboard')?>" class="navbar-brand"><img src="<?php echo base_url('admin-assets/img/custom/logo-system-mini.png');?>" style="height: 50px;"/></a>
...
/* 
            ...
            <?php if(config_item('admin_beginner_enabled') === TRUE):?>
                ...
                <li class="norange<?php echo (strpos($this->uri->uri_string(),'user')!==FALSE && strpos($this->uri->uri_string(),'user/edit/'.$this->session->userdata('id'))===FALSE)?' current':'';?>"><a href="<?php echo site_url('admin/user')?>"><i class="icon-list-alt"></i> <?php echo lang_check('Users');?></a></li>
