                  ...
                  <div class="padd">
                    ...
                    <?php echo form_open(NULL, array('class' => 'form-horizontal', 'role'=>'form'))?>                              
                                ...
                                <div class="form-group">
								  ...
								  <?php $type = $this->user_m->user_types ?> 
								   
<?php $ty = $user->type; ?>
									<select class="form-control" name="type"  id="selectBox">
									
									<?php foreach($type as $k=>$val) { ?>
									     
									   <option value="<?php echo $k; ?>"<?php if ($k == $ty)  echo 'selected = "selected"'; ?>><?php echo $val; ?></option>
                                    ...
                                    <?php //echo form_dropdown('type', $this->user_m->user_types, set_value('type', $user->type), 'class="form-control"', 'onchange="ret_wp()"'); ?>
								...
								<div class="form-group">
                                  <label class="col-lg-2 control-label"><?php echo lang('Experience')?></label>
                                  <div class="col-lg-10">
                                    <?php echo form_input('experience', set_value('experience', $user->experience), 'class="form-control" id="inputNameSurname" placeholder="'.lang('Experience').'"')?>
                                  </div>
								   </div>
								   <div class="form-group">
								   <label class="col-lg-2 control-label"><?php echo lang('Expertise')?></label>
                                  <div class="col-lg-10">
                                    <?php echo form_input('expertise', set_value('expertise', $user->expertise), 'class="form-control" id="inputNameSurname" placeholder="'.lang('Expertise').'"')?>
                                  </div>
								  </div>
								  <div class="form-group">
								  <label class="col-lg-2 control-label"><?php echo lang('Profession')?></label>
                                  <div class="col-lg-10">
                                    <?php echo form_input('profession', set_value('profession', $user->profession), 'class="form-control" id="inputNameSurname" placeholder="'.lang('Profession').'"')?>
                                  </div></div>
								  <div class="form-group">
								  <label class="col-lg-2 control-label"><?php echo lang('AboutMe')?></label>
                                  <div class="col-lg-10">
                                    <?php echo form_input('about', set_value('about', $user->about), 'class="form-control" id="inputNameSurname" placeholder="'.lang('AboutMe').'"')?>
                                  </div>
								  </div>
