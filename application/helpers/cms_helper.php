...
function get_lang_menu ($array, $lang_code, $extra_ul_attributes = '')
{
    ...
    foreach ($array as $item) {
        ...
        if($CI->uri->segment(1) == $listing_uri)
        {
            if($active)
            {
                $str.='<span class="'.$item['code'].' active">'.anchor(slug_url($listing_uri.'/'.$CI->uri->segment(2).'/'.$item['code'].'/'.$CI->uri->segment(4)), $item['language'].$flag_icon).'</span>&nbsp;&nbsp;'.' | ';
            }
            else
            {
                $property_title = '';
                ...
                $str.='<span class="'.$item['code'].'" >'.anchor(slug_url($listing_uri.'/'.$CI->uri->segment(2).'/'.$item['code'].'/'.url_title_cro($property_title)), $item['language'].$flag_icon).'</span>&nbsp;&nbsp;'.' | ';
            }
        }
        else if($CI->uri->segment(1) == 'showroom')
        {
            if($active)
            {
                $str.='<span class="'.$item['code'].' active">'.anchor('showroom/'.$CI->uri->segment(2).'/'.$item['code'], $item['language'].$flag_icon).'</span>&nbsp;&nbsp;'.' | ';
            }
            else
            {
                $str.='<span class="'.$item['code'].'">'.anchor('showroom/'.$CI->uri->segment(2).'/'.$item['code'], $item['language'].$flag_icon).'</span>&nbsp;&nbsp;'.' | ';
            }
        }
        else if($CI->uri->segment(1) == 'profile')
        {
            if($active)
            {
                $str.='<span class="'.$item['code'].' active">'.anchor(slug_url('profile/'.$CI->uri->segment(2).'/'.$item['code']), $item['language'].$flag_icon).'</span>&nbsp;&nbsp;'.' | ';
            }
            else
            {
                $str.='<span class="'.$item['code'].'">'.anchor(slug_url('profile/'.$CI->uri->segment(2).'/'.$item['code']), $item['language'].$flag_icon).'</span>&nbsp;&nbsp;'.' | ';
            }
        }
        else if($CI->uri->segment(1) == 'propertycompare')
        {
            if($active)
            {
                $str.='<span class="'.$item['code'].' active">'.anchor(slug_url('propertycompare/'.$CI->uri->segment(2).'/'.$item['code']), $item['language'].$flag_icon).'</span>&nbsp;&nbsp;'.' | ';
            }
            else
            {
                $str.='<span class="'.$item['code'].'">'.anchor(slug_url('propertycompare/'.$CI->uri->segment(2).'/'.$item['code']), $item['language'].$flag_icon).'</span>&nbsp;&nbsp;'.' | ';
            }
        }
        else if($CI->uri->segment(1) == 'treefield')
        {
            if($active)
            {
                $str.='<span class="'.$item['code'].' active">'.anchor(slug_url('treefield/'.$item['code'].'/'.$CI->uri->segment(3).'/'.$CI->uri->segment(4)), $item['language'].$flag_icon).'</span>&nbsp;&nbsp;'.' | ';
            }
            else
            {
                $str.='<span class="'.$item['code'].'">'.anchor(slug_url('treefield/'.$item['code'].'/'.$CI->uri->segment(3).'/'.$CI->uri->segment(4)), $item['language'].$flag_icon).'</span>&nbsp;&nbsp;'.' | ';
            }
        }
        else if(is_numeric($CI->uri->segment(2)))
        {
            if($active)
            {
                $str.='<span class="'.$item['code'].' active">'.anchor(slug_url($item['code'].'/'.$CI->uri->segment(2), 'page_m'), $item['language'].$flag_icon).'</span>&nbsp;&nbsp;'.' | ';
            }
            else
            {
                $str.='<span class="'.$item['code'].'">'.anchor(slug_url($item['code'].'/'.$CI->uri->segment(2), 'page_m'), $item['language'].$flag_icon).'</span>&nbsp;&nbsp;'.' | ';
            }
        }
        else if($CI->uri->segment(2) != '')
        {
            if($active)
            {
                $str.='<span class="'.$item['code'].' active">'.anchor($CI->uri->segment(1).'/'.$CI->uri->segment(2).'/'.$item['code'].'/'.$CI->uri->segment(4), $item['language'].$flag_icon).'</span>&nbsp;&nbsp;'.' | ';
            }
            else
            {
                $str.='<span class="'.$item['code'].'">'.anchor($CI->uri->segment(1).'/'.$CI->uri->segment(2).'/'.$item['code'].'/'.$CI->uri->segment(4), $item['language'].$flag_icon).'</span>&nbsp;&nbsp;'.' | ';
            }
        }
        else
        {
            ...
            if($active)
            {
                $str.='<span class="'.$item['code'].' active">'.anchor($url_lang_code, $item['language'].$flag_icon).'</span>&nbsp;&nbsp;'.' | ';
            }
            else
            {
                $str.='<span class="'.$item['code'].'">'.anchor($url_lang_code, $item['language'].$flag_icon).'</span>&nbsp;&nbsp;'.' | ';
            }
        }
    }
    $str.='</span>';
