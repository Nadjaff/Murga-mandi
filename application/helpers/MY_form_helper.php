...
function custom_fields_print_f($settings_field)
{
    ...
    ?>
        ...
        <div class="control-group" id="out">		  <div class="controls">            <?php echo form_checkbox('cinput_'.$rel, '1', set_value('cinput_'.$rel, _ch($custom_fields->{'cinput_'.$rel}, '')), 'id="input_alerts_email"')?>            <label class="col-md-12" style="margin-top: -18px;"><?php echo $label; ?></label>          </div>		
