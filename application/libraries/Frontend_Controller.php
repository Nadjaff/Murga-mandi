...
//        header("Connection: close");
       ...
       // Extra JS features enabled
		...
		else if($this->data['page_id'] == 'search' || $this->data['lang_code'] == 'searchlisting'){            $this->data['page_slug'] = '';
		            $this->data['lang_code'] = (string) $this->uri->segment(3); 
		            $this->data['page_id'] = '';  
		}
		else if($this->data['page_id'] == 'grid_view' || $this->data['lang_code'] == 'searchlisting'){            $this->data['page_slug'] = '';
		            $this->data['lang_code'] = (string) $this->uri->segment(3); 
		            $this->data['page_id'] = '';  
		}
		
		else if($this->data['page_id'] == 'doctor' || $this->data['lang_code'] == 'askdoctor'){            
			$this->data['page_slug'] = '';
		    $this->data['lang_code'] = (string) $this->uri->segment(3); 
		    $this->data['page_id'] = '';  
		}
		else if($this->data['page_id'] == 'location_map' || $this->data['lang_code'] == 'locate_map'){            
			$this->data['page_slug'] = '';
		    $this->data['lang_code'] = (string) $this->uri->segment(3); 
		    $this->data['page_id'] = '';  
		}
		else if($this->data['page_id'] == 'otpsend' || $this->data['lang_code'] == 'mobileregister'){ 
		           $this->data['page_slug'] = '';
		            $this->data['lang_code'] = (string) $this->uri->segment(3); 
		            $this->data['page_id'] = ''; 
		...
		/* 
		else if($this->data['page_id'] == 'page_grid_view' || $this->data['lang_code'] == 'searchlisting'){            
			$this->data['page_slug'] = '';
		    $this->data['lang_code'] = (string) $this->uri->segment(3); 
		    $this->data['page_id'] = '';  
		} */
...
//            exit();
        ...
        $this->data['docter_url'] = site_url('askdoctor/doctor/'.$this->data['lang_code']);
		$this->data['docter_url'] = site_url('locate_map/location_map/'.$this->data['lang_code']);
        // edite page link
