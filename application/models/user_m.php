...
class User_m extends MY_Model {
    ...
    public $rules_admin = array(
        ...
        'mail_verified' => array('field'=>'mail_verified', 'label'=>'lang:Mail verified', 'rules'=>'trim|xss_clean'),
		 ...
		 'experience' => array('field'=>'experience', 'label'=>'lang:Experience verified', 'rules'=>'trim|xss_clean'),
		  'expertise' => array('field'=>'expertise', 'label'=>'lang:Expertise verified', 'rules'=>'trim|xss_clean'),
		   'profession' => array('field'=>'profession', 'label'=>'lang:Profession verified', 'rules'=>'trim|xss_clean'),
		    'about' => array('field'=>'about', 'label'=>'lang:AboutMe verified', 'rules'=>'trim|xss_clean'),
    ...
    public $user_types = array('ADMIN', 'DOCTOR', 'FORMER');
    public $user_type_color = array('ADMIN'=>'danger', 'DOCTOR'=>'warning', 'FORMER'=>'success');
	...
	public function __construct(){
        ...
        $this->user_types = array('ADMIN'=>lang_check('ADMIN'), 'DOCTOR'=>lang_check('DOCTOR'), 'FORMER'=>lang_check('FORMER'));
        $this->user_type_color = array('ADMIN'=>'danger', 'DOCTOR'=>'warning', 'FORMER'=>'success');
